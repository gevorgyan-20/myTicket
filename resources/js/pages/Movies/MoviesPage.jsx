...
import { Calendar, MapPin, ChevronDownIcon, LayoutGrid, DollarSign, Search } from "lucide-react";
    ...
    <div className="relative w-full bg-[#0D0D0D] mt-[158px] min-h-screen">
            ...
            {movies.map((movie) => (
              ...
              >
                <div className="relative w-full aspect-[3/4] overflow-hidden">
                  <img
                    src={movie.poster_url || "https://via.placeholder.com/434x580/1B1B1B/666?text=Movie"}
                    alt={movie.title}
      ...
      <section className="relative w-full h-[263px] my-[120px] flex justify-start items-center">
        ...
        <div className="relative z-20 flex flex-col gap-4 items-start justify-center h-full px-[108px]">
            <h3 className="[font-family:'Inter',Helvetica] text-[40px] leading-[48px] font-bold text-white">Start exploring event today!</h3>
            <p className="[font-family:'Inter',Helvetica] text-[24px] leading-[29px] text-[#B3B3B3]">Find concerts,shows,and more near you.</p>
